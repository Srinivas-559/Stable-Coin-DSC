...
contract Handler is Test {
    ...
    constructor(DSCEngine _dsceEngine,DecentralizedStableCoin _dsc) Test(){
        dsce = _dsceEngine;
        dsc = _dsc;
   ...
   vm.startPrank(sender);
    ...
    function redeemCollateral(uint256 collateralSeed ,uint256 amountCollateral) public {
        ...
        uint256 maxCollateralToBeRedeemed = dsce.getCollateralBalanceOfUser(address(collateral),msg.sender);
